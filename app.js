...
function abrirRestaurante(){
  window.open("https://heinerandres.github.io/restaurante/code.html", '_blank');
}

function abrirHotel(){
  window.open("https://heinerandres.github.io/hotel/code.html", '_blank');
}

function abrirArquitecto(){
  window.open("https://heinerandres.github.io/Arquitecto/code.html", '_blank');
}

function abrirCafeteria(){
  window.open("https://heinerandres.github.io/Cafeteria/code.html", '_blank');
}
